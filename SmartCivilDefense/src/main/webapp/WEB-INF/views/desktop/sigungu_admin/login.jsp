...
<body>
	<div class="container">
	<div class="row">
    	<div class="col-12 text-center mt-3">스마트 민방위 시/군/구 관리자 로그인</div>
    </div>
    <div class="row">
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            $("#loginBtn").on("click", function(e){
                e.preventDefault();
                fn_loginSigunguAdmin();
            });
        });
         
        function fn_loginSigunguAdmin(){
            var comSubmit = new ComSubmit("frm");
            comSubmit.setUrl("<c:url value='/sigungu_admin/loginCheck.do'/>");
            comSubmit.submit();
        }
    </script>
</body>
