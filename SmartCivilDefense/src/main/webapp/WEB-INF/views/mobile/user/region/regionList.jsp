...
<body>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			$("a[name='SIDO']").on("click", function(e){ //제목
				e.preventDefault();
         ...
         function fn_selectRegionList(pageNo){
        	 var comAjax = new ComAjax();
        	 comAjax.setUrl("<c:url value='/region/selectRegionList.do' />");
        	 comAjax.setCallback("fn_selectRegionListCallback");
        	 /* comAjax.addParam("PAGE_INDEX", pageNo);
        	 comAjax.addParam("PAGE_ROW", 15); */
        	 comAjax.ajax();
         }
         
         function fn_selectRegionListCallback(data){
        	 ...
        	 if(total == 0){
        		 ...
        		 $.each(data.list, function(key, value){
        			 str += "<tr>" + 
        			 			"<td>" + 
        			 					"<a href='#this' name='SIDO'>" + value.SIDO + "</a>" + 
